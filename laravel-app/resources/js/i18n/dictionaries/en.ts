const en = {
  ...
  pos: {
    ...
    hold: {
      button: "Hold",
      dialogTitle: "Hold this order",
      referenceLabel: "Reference (optional)",
      referencePlaceholder: "e.g. John / Table 4",
      confirm: "Hold order",
      listTitle: "Held orders",
      listEmpty: "No held orders for this store.",
      resume: "Resume",
      delete: "Delete",
      failed: "Failed to hold order",
      savedToast: "Order held",
      resumedToast: "Held order resumed",
    },
    weight: {
      dialogTitle: (name: string) => `Enter weight — ${name}`,
      label: "Weight",
      add: "Add to cart",
      lineTotal: "Line total",
    },
    checkout: {
      title: "Take payment",
      draftItems: (n: number) => `Draft · ${n} item(s)`,
      totalDue: "Total due",
      cashGiven: "Cash given",
      changeDue: "Change due",
      reference: "Reference",
      referencePlaceholder: "Card last 4 / UPI txn / cheque #...",
      referenceHelp: "Enter the transaction reference so it lands on the receipt.",
      acceptCash: "Accept cash",
      takePayment: "Take payment",
      qrWaiting: "Waiting for customer to scan...",
      qrHelp:
        "Ask the customer to scan with their phone. They will choose how to pay — UPI, card, wallet, or any other configured method.",
      qrConfirm: "Payment received",
      cancelPayment: "Cancel payment",
      withChange: "With change",
      withReference: "With reference",
      customerPicksGateway: "Customer picks the gateway",
    ...
    receipt: {
      notFound: (id: string) => `No sale found for id "${id}".`,
      cashier: "Cashier",
      subtotal: "Subtotal",
      discount: "Discount",
      tax: "Tax",
  ...
  auth: {
    ...
    subtitle: "Sign in to continue to your Hyper POS account.",
    taglineTitle: "Run your whole store from one screen.",
    taglineSubtitle: "Sales, inventory and reports — fast, reliable, built for your team.",
    emailLabel: "Email",
