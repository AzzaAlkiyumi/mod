...
export function MobileNav() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="left-0 top-0 h-dvh max-w-72 translate-x-0 translate-y-0 rounded-none border-r border-l-0 border-t-0 border-b-0 p-0 sm:max-w-72">
