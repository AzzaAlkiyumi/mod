...
/** Order and grouping match the reference video exactly. Only Currency &
 * formatting is backed by real data (Setting model) — every other card
 * routes to the shared Coming Soon placeholder, same convention used
 * throughout Administration for sections not yet built. */
